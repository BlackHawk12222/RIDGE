...
def draw_button_at_x_y_width_width_height_height(draw_button_at_x_y_width_width_height_height__x, draw_button_at_x_y_width_width_height_height__y, draw_button_at_x_y_width_width_height_height__width, draw_button_at_x_y_width_width_height_height__height):
    ...
    if brain.screen.pressing():
        if draw_button_at_x_y_width_width_height_height__x < brain.screen.x_position() < (draw_button_at_x_y_width_width_height_height__x + draw_button_at_x_y_width_width_height_height__width) and draw_button_at_x_y_width_width_height_height__y < brain.screen.y_position() < (draw_button_at_x_y_width_width_height_height__y + draw_button_at_x_y_width_width_height_height__height):
            button_pressed = 1
...
def bootAnim():
    ...
    while True:
        ...
        draw_button_at_x_y_width_width_height_height(100, 100, 100, 100)
        if button_pressed == 1:
            Auto_Side = "l"
            break
        brain.screen.set_pen_color(Color.PURPLE)
        brain.screen.set_fill_color(Color.TRANSPARENT)
        draw_button_at_x_y_width_width_height_height(210, 100, 100, 100)
        if button_pressed == 1:
            Auto_Side = "r"
            break
        brain.screen.render()
